...
> This is the original design spec the project was built from. The
> implementation currently covers the first vertical slice (see the "First
> Milestone" section and the repository README for current status).
...
- Direct conflict between the autonomy rules and the project's confirmation rule
